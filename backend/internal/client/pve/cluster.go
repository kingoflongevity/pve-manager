...
// 返回指定类型的资源列表
func (c *Client) GetClusterResourcesByType(ctx context.Context, resourceType string) (interface{}, error) {
	var resources interface{}
	params := url.Values{}
	if resourceType != "" {
...
// 返回集群中所有节点的任务
func (c *Client) GetClusterTasks(ctx context.Context) (interface{}, error) {
	var tasks interface{}
...
// 返回可用于创建新虚拟机或容器的 ID
func (c *Client) GetNextID(ctx context.Context) (interface{}, error) {
...
// 返回高可用配置（组、资源、隔离设备）
func (c *Client) GetHAConfig(ctx context.Context) (interface{}, error) {
...
// 返回所有高可用组配置
func (c *Client) GetHAGroups(ctx context.Context) (interface{}, error) {
...
// 返回所有高可用资源配置
func (c *Client) GetHAResources(ctx context.Context) (interface{}, error) {
	var resources interface{}
...
// 返回所有软件定义网络区域
func (c *Client) GetSDNZones(ctx context.Context) (interface{}, error) {
	var zones interface{}
...
// 返回所有 SDN 虚拟网络
func (c *Client) GetSDNVNETs(ctx context.Context) (interface{}, error) {
	var vnets interface{}
...
// ListPools 获取所有资源池列表
// 返回所有资源池的简要信息
func (c *Client) ListPools(ctx context.Context) (interface{}, error) {
	var pools interface{}
...
// poolid: 资源池 ID
// 返回资源池的成员和配置
func (c *Client) GetPool(ctx context.Context, poolid string) (interface{}, error) {
...
// 返回集群级别的日志
func (c *Client) GetClusterLog(ctx context.Context) (interface{}, error) {
	var logs interface{}
...
// 返回集群的全局配置选项
func (c *Client) GetClusterOptions(ctx context.Context) (interface{}, error) {
