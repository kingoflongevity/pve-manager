  ...
  <div class="overview-tab">
    ...
    <el-card class="info-card">
      ...
      <el-descriptions :column="2" border>
        <el-descriptions-item label="VM ID">{{ config.vmid }}</el-descriptions-item>
    ...
    <el-card class="gauges-card">
      ...
      <div class="gauges-grid">
        ...
        <ResourceGauge :value="diskUsage" :max="100" label="磁盘使用率" />
        <ResourceGauge :value="0" :max="100" label="网络 I/O" unit="KB/s" />
      </div>
    </el-card>
...
import { Refresh, VideoPlay, VideoPause, RefreshRight, SwitchButton, Camera, CaretRight } from '@element-plus/icons-vue'
